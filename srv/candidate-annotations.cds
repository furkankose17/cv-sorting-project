...
annotate CVSortingService.Candidates with @(
    Capabilities: {
        ...
        Identification: [
            {
                ...
                Action: 'CVSortingService.updateStatus',
                Label: '{i18n>UpdateStatus}',
                ![@UI.Importance]: #High
            },
            {
                $Type: 'UI.DataFieldForAction',
                Action: 'CVSortingService.addSkill',
                Label: '{i18n>AddSkill}',
                ![@UI.Importance]: #Medium
            }
...
// WORK EXPERIENCES
// ============================================
annotate CVSortingService.WorkExperiences with @(
    UI: {
        LineItem: [
...
// EDUCATIONS
// ============================================
annotate CVSortingService.Educations with @(
    UI: {
        LineItem: [
...
// CANDIDATE SKILLS
// ============================================
annotate CVSortingService.CandidateSkills with @(
    UI: {
        LineItem: [
...
// CV DOCUMENTS
// ============================================
annotate CVSortingService.CVDocuments with @(
    UI: {
        LineItem: [
...
// CANDIDATE NOTES
// ============================================
annotate CVSortingService.CandidateNotes with @(
    UI: {
        LineItem: [
...
// CANDIDATE LANGUAGES
// ============================================
annotate CVSortingService.CandidateLanguages with @(
    UI: {
        HeaderInfo: {
...
// CERTIFICATIONS
// ============================================
annotate CVSortingService.Certifications with @(
    UI: {
        HeaderInfo: {
...
// CANDIDATE STATUSES
// ============================================
annotate CVSortingService.CandidateStatuses with @(
    UI: {
        LineItem: [
...
// INTERVIEWS
// ============================================
annotate CVSortingService.Interviews with @(
    UI: {
        HeaderInfo: {
        ...
        Identification: [
            {
                $Type: 'UI.DataFieldForAction',
                Action: 'CVSortingService.confirm',
                Label: '{i18n>Confirm}',
                ![@UI.Importance]: #High
            },
            {
                $Type: 'UI.DataFieldForAction',
                Action: 'CVSortingService.complete',
                Label: '{i18n>Complete}',
                ![@UI.Importance]: #High
            },
            {
                $Type: 'UI.DataFieldForAction',
                Action: 'CVSortingService.cancel',
                Label: '{i18n>Cancel}',
                ![@UI.Importance]: #Medium
            },
            {
                $Type: 'UI.DataFieldForAction',
                Action: 'CVSortingService.reschedule',
                Label: '{i18n>Reschedule}',
                ![@UI.Importance]: #Medium
            },
            {
                $Type: 'UI.DataFieldForAction',
                Action: 'CVSortingService.submitFeedback',
                Label: '{i18n>SubmitFeedback}',
                ![@UI.Importance]: #High
            },
            {
                $Type: 'UI.DataFieldForAction',
                Action: 'CVSortingService.recordNoShow',
